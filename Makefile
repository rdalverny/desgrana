...
buildinfo:
	@mkdir -p $(dir $(BUILDINFO)); \
	 ...
	 { echo "// Generated by 'make buildinfo' — do not edit, gitignored."; \
	   ...
	   echo "    static let gitSHA = \"$(GIT_SHA)\""; \
	   echo "    static let gitDescribe = \"$(GIT_DESCRIBE)\""; \
	   echo "    static let gitDirty = $(GIT_DIRTY)"; \
	   echo "    static let buildDate = \"$(BUILD_DATE)\""; \
	   echo "    static let swiftVersion = \"$(SWIFT_VERSION)\""; \
	   echo "    static let toolchain = \"$(TOOLCHAIN)\""; \
	   echo "}"; } > $$tmp; \
